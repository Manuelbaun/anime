...
function anime(params) {
  ...
  instance.tick = function(t) {
    ...
    if (instance.useDeltaTime) {
      ...
      var progress = instance.currentTime + deltaTime * anime.speed;
      setInstanceProgress(progress);
    } else {
      // old calculation
      var progress$1 = (now + (lastTime - startTime)) * anime.speed;
      setInstanceProgress(progress$1);
    }
  };
  ...
  instance.continue = function () {
    ...
    if (instance.completed) {
      ...
      children = instance.children;
      childrenLength = children.length;
      var aniProgress = instance.reversed ? instance.duration : 0;
